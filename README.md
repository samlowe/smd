...
```sh
chmod +x smd_0.3.2_amd64.AppImage
./smd_0.3.2_amd64.AppImage
```
...
- Disk image: `src-tauri/target/release/bundle/dmg/smd_0.3.2_aarch64.dmg`
...
- Installer: `src-tauri\target\release\bundle\msi\smd_0.3.2_x64_en-US.msi`
- Setup: `src-tauri\target\release\bundle\nsis\smd_0.3.2_x64-setup.exe`
